...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="btnFind" runat="server" Height="25px" OnClick="btnFind_Click" Text="Find" Width="91px" />
            <br />
        ...
        <br />
        <br />
        <asp:Button ID="btnOK" runat="server" Text="OK" Width="36px" OnClick="btnOK_Click" />
